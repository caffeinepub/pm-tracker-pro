...
export class Backend implements backendInterface {
    ...
    async addChecklistTemplate(arg0: ChecklistTemplate): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addChecklistTemplate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addPMPlan(arg0: PMPlan): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addPMPlan(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPMRecords(): Promise<Array<PMRecord>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPMRecords();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getChecklistTemplate(arg0: string): Promise<ChecklistTemplate> {
        if (this.processError) {
            try {
                const result = await this.actor.getChecklistTemplate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTodaysPlan(arg0: bigint): Promise<Array<PMPlan>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTodaysPlan(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async submitPMRecord(arg0: PMRecord): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPMRecord(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
